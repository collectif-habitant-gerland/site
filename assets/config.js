...
window.VOIX_CONFIG = {
  ...
  themes: [
    { id: 'acces', icone: 'acces', titre: 'Accès et sécurité de l’immeuble',
      detail: 'Portes d’entrée, badges, interphone, boîtes aux lettres, intrusions, personnes installées dans les communs.',
      demande: 'Sécuriser les entrées : portes qui ne ferment plus, badges qui refusent l’accès, interphones en panne et boîtes aux lettres forcées. Empêcher les intrusions et les installations dans les halls et les escaliers.' },
    { id: 'garages', icone: 'garages', titre: 'Garages et sous-sols',
      detail: 'Portail et portes, squats et intrusions, effractions de box, propreté, éclairage.',
      demande: 'Sécuriser les garages et les sous-sols : portail et portes réparés et fermés, serrures en état, éclairage en service, et action rapide contre les squats, les intrusions et les effractions de box.' },
